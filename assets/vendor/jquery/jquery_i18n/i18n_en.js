jQuery(document).ready(function () {
  ...
  $.i18n().load({
    'en': {
      ...
      'section-products-chat-bot-agent-header': 'Courier Agent',
      ...
      'section-products-chat-bot-clients-header-#1': 'Some of the benefits that your clients will have are the following:',
      'section-products-chat-bot-clients-header-#1-1': 'Immediate and uninterrupted response: The ChatBot is available 24 hours a day, 7 days a week, allowing customers to get fast, real-time responses to their queries or needs, regardless of the time of day.',
      'section-products-chat-bot-clients-header-#1-2': 'Personalized and appropriate customer service: The ChatBot is programmed to provide personalized service, adapting to the needs and preferences of each customer. You can offer targeted recommendations, answer personalized questions, and provide support tailored to each situation.',
      'section-products-chat-bot-clients-header-#1-3': 'Instant transactions: Customers can carry out transactions instantly through the ChatBot, such as making purchases, making balance inquiries, scheduling appointments, requesting information, among others, without the need to wait in long lines or wait for responses through other communication channels.',
      'section-products-chat-bot-clients-header-#1-4': 'Greater satisfaction with the service: Uninterrupted availability, personalized attention and the ability to carry out transactions instantly contribute to increasing the general satisfaction of clients with the service offered by the institution.',
