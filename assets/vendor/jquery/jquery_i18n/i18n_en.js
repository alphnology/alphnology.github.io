jQuery(document).ready(function () {
  ...
  $.i18n().load({
    'en': {
      ...
      'section-products-details-#3': 'Offers an unparalleled level of flexibility. You have the freedom to customize, build, integrate, or replace components to perfectly adapt it to your requirements. The CRM template comes equipped with a wide range of customizable features that allow you to optimize your sales processes with maximum efficiency.',
      ...
      'section-products-details-#9': 'Timesched is an appointment scheduling system for patients, which allows for complete control over the center`s commitments. This scheduling system facilitates the efficient administration of medical appointments, providing a comprehensive tool for the management and tracking of patient schedules.',
      'section-products-header-#10': 'Chat-Alph',
      'section-products-details-#10': 'ChatAlph offers tools to manage conversations, build relationships, and delight your customers from a single platform, facilitating communication and optimizing the customer experience. The centralized platform simplifies management and promotes efficient, personalized customer service.',
      'section-products-header-#11': 'Theodolite',
      'section-products-details-#11': 'Theodolite, a software created by surveyors and designed exclusively for them, facilitates total file management. This generates superior customer satisfaction by simplifying the management of project-related information, ensuring a positive experience in every interaction.',
      //======= Products Section =======
      //
      //======= Team Section =======
      ...
      'section-products-timesched-#1': 'With Timesched, precise organization is achieved, allowing healthcare professionals to optimize their time and provide more effective service. Additionally, the platform offers the ability to track detailed availability of doctors, manage cancellations and rescheduling, and maintain a comprehensive record of past and future appointments. In summary, Timesched not only simplifies appointment management but also contributes to improving efficiency and the overall experience for both medical staff and patients.',
      'section-products-timesched-#2': 'Timesched, by providing total control of appointment management, stands out for being packed with features that significantly enhance efficiency and the experience in appointment and service administration.',
      'section-products-timesched-#3': 'Together, these features make Timesched a comprehensive and powerful tool for appointment management, providing an efficient and organized environment that benefits both healthcare professionals and patients.',
      'section-products-timesched-#4': 'Some images of the dashboard',
      'section-products-timesched-#5': 'Welcome to the revolution in appointment and professional services management. We proudly introduce Timesched, the comprehensive solution designed to empower healthcare professionals and provide an exceptional experience for patients. In this brochure, we will explore the highlighted features that make Timesched an indispensable tool in appointment management, from its flexibility to schedule recurring appointments to detailed visualization of schedules by consultation rooms. Discover how Timesched transforms management, allowing for more efficient care, effortless organization, and superior satisfaction for all.',
      'section-products-timesched-#6': 'In conclusion, Timesched is not just an appointment management software; it is a strategic ally for your practice. With the ability to optimize schedules, manage specialists, and provide total control over billing and advances, Timesched stands out as the complete tool that elevates operational efficiency and improves the quality of care. Don`t miss the opportunity to simplify your practice and provide your patients with an unparalleled service experience. Discover the future of management with Timesched today!',
      'section-products-timesched-feature': 'Among these features, it includes:',
      'section-products-timesched-feature-#1': 'Flexibility in Appointment Creation: The ability to create single or recurring appointments, adapting to the specific needs of patients and professional staff.',
      'section-products-timesched-feature-#2': 'Recurring Appointments: Possibility to schedule appointments that repeat periodically, such as monthly or weekly appointments. Facilitating the management of follow-ups that require multiple sessions.',
      'section-products-timesched-feature-#3': 'Referrals to Other Professionals: Facilitates coordination between different professionals, allowing the referral of patients to other specialists in a straightforward manner.',
      'section-products-timesched-feature-#4': 'Appointment Management Under Different Conditions: Allows scheduling appointments under various conditions, adapting to the specific policies and requirements of the center.',
      'section-products-timesched-feature-#5': 'Cancellation Control: Offers efficient management of cancellations, with the possibility of generating charges automatically, ensuring effective financial administration.',
      'section-products-timesched-feature-#6': 'Assignment of Rooms to Specialists: Optimizes the allocation of rooms to specialists, improving organization and the utilization of available resources.',
      'section-products-timesched-feature-#7': 'Appointment Calendar Generator: Provides a clear and organized view of the calendar, facilitating scheduling and daily appointment management.',
      'section-products-timesched-feature-#8': 'Visualization of Appointments by Rooms: Allows users to quickly and efficiently visualize appointments assigned to each room, facilitating the equitable distribution of patients among different care spaces.',
      'section-products-timesched-feature-#9': 'Management of Specialists and Availability: Allows administrators and coordinators to manage the workload of specialists, ensuring efficient distribution of appointments. This provides real-time information on the availability of each specialist, facilitating scheduling and avoiding agenda conflicts.',
      'section-products-timesched-feature-#10': 'Patient Advances and Advance Reconciliation: Allows recording advances made by patients as part of the reservation or prepayment process. Facilitating the reconciliation of advances, ensuring accurate tracking of payments made by patients before receiving medical services.',
      'section-products-timesched-feature-#11': 'Dashboard: Offers a centralized panel that provides a panoramic view of key metrics and the overall status of the center. Includes visual graphs, statistics, and summaries that facilitate quick decision-making and effective monitoring of operations.',
      'section-products-timesched-feature-#12': 'Patient History: Facilitates access to a complete patient history, improving customer care and enabling a more personalized approach.',
      'section-products-timesched-feature-#13': 'Comprehensive Control of Invoices and Collections: Simplifies financial management with comprehensive control of invoices and collections, contributing to more effective and transparent administration.',
      'section-products-timesched-feature-#14': 'Commission Reports: Generates detailed reports on commissions generated by healthcare professionals. Facilitating transparency in income and providing a clear view of the financial performance of each specialist.',
      'section-products-timesched-feature-#15': 'User Privileges and Access Limitation: Ensures security and privacy with detailed user privileges and hour-based access limitation.',
      'section-products-chatalph-#1': 'In an interconnected and digital world, effective management of online conversations has become a cornerstone for business success. In this context, Chat-Alph stands as a conversation management platform that goes beyond expectations, offering a comprehensive solution for customer communication across various channels.',
      'section-products-chatalph-#2': 'Connect with popular customer communication channels such as WhatsApp, Instagram, Facebook, Telegram, SMS, email, live chat on the website, among others. This allows you to provide a consistent customer experience across various channels, all from a single control panel.',
      'section-products-chatalph-#3': 'This product emerges as a comprehensive and versatile solution for efficient online conversation management. By connecting with a wide range of popular communication channels, from WhatsApp and Facebook to SMS and live chat on the website, it provides a centralized platform from which businesses can offer a consistent and personalized experience to their customers.',
      'section-products-chatalph-#4': 'The ability to connect with customers through multiple channels, along with features like live chat, seamless team collaboration, and intelligent automation, make this product an indispensable tool for improving productivity and service quality. The flexibility of integration with chatbots and other platforms through APIs allows adaptation to the specific needs of each business.',
      'section-products-chatalph-#5': 'With additional features such as labels for organizing conversations, private notes for internal collaboration, and predefined responses to streamline frequent answers, this product presents itself as a complete and user-friendly solution. Whether for small businesses or large corporations, it offers effective conversation management that simplifies customer interaction and improves operational efficiency. In summary, this is a definitive tool to transform how businesses communicate and connect with their customers online.',
      'section-products-chatalph-#6': 'Join us in the revolution of online conversation management. Transform the way you communicate and connect with your customers, providing them an exceptional experience and taking your business to the next level.',
      'section-products-chatalph-feature-#1': 'Connect with your customers through more than one channel',
      'section-products-chatalph-feature-#1-1': 'Link your Facebook page and Instagram direct messages to view all conversations from Messenger.',
      'section-products-chatalph-feature-#1-2': 'Create a business account for WhatsApp, connect it, and start interacting with your customers.',
      'section-products-chatalph-feature-#1-3': 'Use the API channel to address custom use cases. APIs provide flexibility to integrate with any third-party tool.',
      'section-products-chatalph-feature-#2': 'Facilitate customer engagement, allowing your team to be more productive, quick, and collaborate without switching applications.',
      'section-products-chatalph-feature-#2-1': 'Live chat on the website: A simple and elegant live chat for your website.',
      'section-products-chatalph-feature-#2-2': 'Team collaboration: Communicate with your team members without leaving the platform. Use private notes to mention your colleagues and discuss customer interactions with them.',
      'section-products-chatalph-feature-#2-3': 'Automate repetitive tasks: Set up automation rules to handle the most tedious tasks, so your customers receive all your attention.',
      'section-products-chatalph-feature-#2-4': 'Omnichannel inbox: Connect any channel and communicate with your customers from one place.',
      'section-products-chatalph-feature-#2-5': 'Chatbots: Easily integrate with chatbot platforms like Rasa or Dialogflow to reduce the workload of your agents.',
      'section-products-chatalph-feature-#2-6': 'Labels: Add labels to conversations to keep them organized.',
      'section-products-chatalph-feature-#2-7': 'Private notes: Discuss customer inquiries privately with your team members.',
      'section-products-chatalph-feature-#2-8': 'Business hours: Inform customers when you are not available to answer their questions.',
      'section-products-chatalph-feature-#2-9': 'Predefined responses: Respond to frequently asked questions using predefined answers.',
